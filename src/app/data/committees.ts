...
export const scientificCommitteeMembers: CommitteeMember[] = [
  ...
  { name: 'Prof. Osman Tiryaki', institution: 'Canakkale Onsekiz Mart University', country: 'Turkey', image: '/committee/Prof. Osman Tiryaki.png' },
  ...
  { name: 'Prof. Antonio Valverde', institution: '', country: '', image: '/committee/Prof. Antonio Valverde.jpg' },
  { name: 'Prof. Ntalli Nikoletta', institution: 'Aristotle University of Thessaloniki', country: 'Greece', image: committeePortrait },
  { name: 'Prof. Abderrahim Hormatallah', institution: "IAV Hassan II, Complexe Horticole d'Ait Melloul", country: 'Morocco', image: '/committee/Prof. Abderrahim Hormatallah.jpg' },
  { name: 'Prof. Zsofia Kovacs', institution: 'University of Pannonia, Veszprem', country: 'Hungary', image: committeePortrait },
  { name: 'Prof. Nafissa Soudani', institution: 'University Mohamed Khider of Biskra', country: 'Algeria', image: '/committee/Prof. Nafissa Soudani.jpg' },
  { name: 'Prof. Mariateresa Russo', institution: 'University of Reggio Calabria', country: 'Italy', image: committeePortrait },
  { name: 'Prof. Khaoula Toumi', institution: '', country: '', image: '/committee/Prof. Khaoula Toumi.jpg' },
  ...
  { name: 'Prof. Manar Fawzi Bani Mfarrej', institution: 'University of Abu Dhabi', country: 'United Arab Emirates', image: '/committee/Prof. Manar Fawzi Bani Mfarrej.png' },
  { name: 'Prof. Ahmad Elmoll', institution: 'Lebanese University', country: 'Lebanon', image: '/committee/Prof. Ahmad Elmoll.jpg' },
  { name: 'Prof. Djilani G. Amara', institution: 'El Oued University', country: 'Algeria', image: '/committee/Prof. Djilani G. Amara.jpg' },
  ...
  { name: 'Prof. Halim Hammi', institution: 'National Centre of Research in Materials Science (CNRSM)', country: 'Tunisia', image: '/committee/Prof. Halim Hammi .jpeg' },
